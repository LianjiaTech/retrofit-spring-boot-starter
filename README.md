...
- <span style="color:red">Spring Boot 3.x 项目，请使用retrofit-spring-boot-starter 3.x </span>
- <span style="color:red">Spring Boot 1.x/2.x 项目，请使用retrofit-spring-boot-starter 2.x </span>，支持Spring Boot
  1.4.2及以上版本。
