...
@Slf4j
public class Rxjava2SingleTest {

    @Autowired
    private Rxjava2SingleTestApi rxjava2SingleTestApi;
    ...
    public void test() {
        ...
        // http check
        Single<Result<Person>> single = rxjava2SingleTestApi.getPerson(1L);
    ...
    public void testResponse() {
        ...
        // http check
        Single<Response<Result<Person>>> personResponse = rxjava2SingleTestApi.getPersonResponse(1L);
        log.info("=======Single立即返回，但未执行调用=======");
