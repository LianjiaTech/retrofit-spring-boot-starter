...
public class Resilience4jDegradeRuleRegister implements DegradeRuleRegister<CircuitBreakerConfig> {
    ...
    public CircuitBreakerConfig newInstanceByDefault(Map<String, Object> attrMap){
        ...
        return CircuitBreakerConfig.custom()
                // 滑动窗口的类型为时间窗口
                .slidingWindowType(convertOrDefault(CircuitBreakerConfig.SlidingWindowType.class, attrMap.get("slidingWindowType"), CircuitBreakerConfig.SlidingWindowType.TIME_BASED))
                // 时间窗口的大小为60秒
