...
/**
 * 方法级 / 类级超时配置，优先级高于 {@code @RetrofitClient} 和全局超时属性。
 * <p>
 ...
 * <p>
 * Method-level / class-level timeout configuration, higher priority than {@code @RetrofitClient}
 * and global timeout properties.
 * <p>
