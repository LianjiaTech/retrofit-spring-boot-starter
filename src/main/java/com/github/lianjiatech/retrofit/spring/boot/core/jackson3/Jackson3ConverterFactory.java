...
public final class Jackson3ConverterFactory extends Converter.Factory {
  ...
  public static Jackson3ConverterFactory create() {
    return new Jackson3ConverterFactory(new ObjectMapper(), DEFAULT_MEDIA_TYPE, false);
  }
  ...
  private Jackson3ConverterFactory(ObjectMapper mapper, MediaType mediaType, boolean streaming) {
    this.mapper = mapper;
   ...
   */
  public Jackson3ConverterFactory withStreaming() {
    return new Jackson3ConverterFactory(mapper, mediaType, true);
  }
  ...
  public Converter<ResponseBody, ?> responseBodyConverter(
    ...
    return new Jackson3ResponseBodyConverter<>(reader);
  }
  ...
  public Converter<?, RequestBody> requestBodyConverter(
    ...
    return new Jackson3RequestBodyConverter<>(writer, mediaType, streaming);
  }
}